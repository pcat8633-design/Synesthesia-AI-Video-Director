...
def generate_performance_description(concept, plot, gender, llm_model, video_mode="Intercut"):
    ...
    user_prompt = (
        f"Concept: {concept}\nPlot: {plot}\n{gender_instruction}\n"
        "Task: Invent and sescribe the physical appearance, proper name, age, hair, clothing, and style of a lead singer for the above song, specifically for an AI video generation model. Start with the phrase 'Handheld dynamic closeup shot of'.  Do not include any details about the character that would be out of view in a close-up shot. End the description with; [name of singer] is careful to enunciate each word to the camera to account for thier deaf sister's lip reading. Shot with a dynamic camera movement and slight handheld shake, shallow depth of field, dramatic chiaroscuro lighting, 85mm lens, 24fps, high contrast, crowd silhouettes, energetic atmosphere, cinematic color grading, [describe color pallet here] "
